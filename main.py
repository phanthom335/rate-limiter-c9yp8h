    ...
    Rate Limiter C9yp8h
    ===================
    Open-source API service that forwards data between clients and backends.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that forwards data between clients and backends.")
